                ...
                <div class="x_panel">
                  ...
                  <div class="col-md-100">
                      ...
                      <div class="image view view-first">
                        <img style="height:500%;" width="30%" src='/{{ $partner->image }}' alt="partner" />
                        <div class="mask">
                          <p> <a href="{{ url($partner->image) }}" target="_blank"> <b style="font-size: 24px; color:aliceblue">Open Picture</b> </a> </p>
                          <div class="tools tools-bottom">
                            <a href="{{ url($partner->image) }}" target="_blank"><i class="fa fa-eye"></i></a>
                          </div>
                        </div>
                      </div>
                ...
                <div class="col-md-12 col-sm-12 ">
                  <div class="x_panel">
                    ...
                    <div class="x_content">
                     ...
                     <div class="caption">
                        <p>Partner Name:  {{ $partner->name }} </p><hr>
                        <p>Location:  {{ $partner->location }}</p><hr>
                        <p>Created:  {{ $partner->created_at }}</p><hr>
                      </div>
                                    ...
                                    @method('PUT')
                                        <div class="row">
                                          ...
                                          <div class="form-group col-md-12">
                                            ...
                                            @enderror
                                            <input type="text" value="{{ $partner->name }}" name="name" class="form-control" id="cat" >
                                        </div>
                                        ...
                                        <div class="form-group col-md-12">
                                            ...
                                            @enderror
                                            <input type="text" value="{{ $partner->location }}" name="location" class="form-control" id="cat" >
                                        </div>
