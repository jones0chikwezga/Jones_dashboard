                ...
                <div class="x_panel">
                  ...
                  <div class="col-md-100">
                      ...
                      <div class="image view view-first">
                        <img style="height:500%;" width="30%" src='/{{ $team->image }}' alt="partner" />
                        <div class="mask">
                          <p> <a href="{{ url($team->image) }}" target="_blank"> <b style="font-size: 24px; color:aliceblue">Open Document</b> </a> </p>
                          <div class="tools tools-bottom">
                            <a href="{{ url($team->image) }}" target="_blank"><i class="fa fa-eye"></i></a>
                          </div>
                        </div>
                      </div>
                ...
                <div class="col-md-12 col-sm-12 ">
                  <div class="x_panel">
                    ...
                    <div class="x_content">
                     ...
                     <div class="caption">
                        <p>Partner Name:  {{ $team->name }} </p><hr>
                        <p>Location:  {{ $team->position }}</p><hr>
                        <p>Created:  {{ $team->created_at }}</p><hr>
                      </div>
                                    ...
                                    @method('PUT')
                                        <div class="row">
                                          ...
                                          <div class="form-group col-md-12">
                                            ...
                                            @enderror
                                            <input type="text" value="{{ $team->name }}" name="name" class="form-control" id="cat" >
                                        </div>
                                        ...
                                        <div class="form-group col-md-12">
                                            ...
                                            @enderror
                                            <input type="text" value="{{ $team->position }}" name="position" class="form-control" id="cat" >
                                        </div>
