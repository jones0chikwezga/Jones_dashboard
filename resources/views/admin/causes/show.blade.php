                ...
                <div class="x_panel">
                  <div class="x_title">
                    ...
                    <ul class="nav navbar-right panel_toolbox">
                      <form action="/causes/{{ $cause_details->id }}" method="post">
                        @csrf
                        @method('delete')
                  ...
                  <div class="col-md-100">
                      ...
                      <div class="image view view-first">
                        <img style="height:500%;" width="30%" src='/{{ $cause_details->image }}' alt="{{ $cause_details->image }}" />
                        <div class="mask">
                          <p> <a href="{{ url($cause_details->image) }}" target="_blank"> <b style="font-size: 24px; color:aliceblue">Open Document</b> </a> </p>
                          <div class="tools tools-bottom">
                            <a href="{{ url($cause_details->image) }}" target="_blank"><i class="fa fa-eye"></i></a>
                          </div>
                        </div>
                ...
                <div class="col-md-12 col-sm-12 ">
                  <div class="x_panel">
                    ...
                    <div class="x_content">
                     ...
                     <div class="caption">
                      <p>Title: {{ $cause_details->title }} </p> <hr>
                      <p>Category: <i class="fa fa-tag"></i>  {{ $cause_details->category }} </p> <hr>
                      <p>Description:  {!! $cause_details->description !!} </p><hr>
                    
                      <p>Created:  {{ $cause_details->created_at }} </p><hr>
                     ...
                     <div class="modal-dialog modal-lg" role="document">
                         <div class="modal-content">
                             ...
                             <div class="modal-body">
                              ...
                              <form action="/causes/{{ $cause_details->id }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                    <div class="row">
                                      ...
                                      <div class="form-group col-md-12">
                                        ...
                                        @enderror
                                        <input type="text" value="{{ $cause_details->title }}" name="title" class="form-control" id="cat" >
                                    </div>
                                        ...
                                        <div class="form-group col-md-12">
                                            ...
                                            <select class="form-control required select2" name="category" id="validationSelect1"
                                                >
                                                <option value="{{ $cause_details->category }}">{{ $cause_details->category }}</option>
                                        ...
                                        <div class="form-group col-md-12">
                                            ...
                                            @enderror
                                            <textarea name="description"  class="form-control" id="cat" > {{ $cause_details->donor }} </textarea>
                                        </div>
                                        ...
                                        {{-- <div class="form-group col-md-12">
                                            ...
                                            @enderror
                                            <input type="number" name="donated" value="{{ $cause_details->donated }}" class="form-control" id="cat" >
                                        </div> --}}
