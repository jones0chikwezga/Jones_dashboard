                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered" style="width:100%">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td><a class = "btn btn-primary btn-sm" href="/category/{{ $item->id }}"> <i class="fa fa-pencil"></i> </a> </td>
                        </tr>
                        @endforeach
                                    ...
                                    @method('POST')
                                        <div class="row">
                                          ...
                                          <div class="form-group col-md-12">
                                            ...
                                            @enderror
                                            <input type="text" name="category_name" value="{{ old('category_name') }}" class="form-control" id="cat" >
                                        </div>
