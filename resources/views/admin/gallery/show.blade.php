                ...
                <div class="x_panel">
                  <div class="x_title">
                    ...
                    <ul class="nav navbar-right panel_toolbox">
                      ...
                      <form action="/gallerys/{{ $gallery->id }}" method="post">
                        @csrf
                        @method('delete')
                  ...
                  {{-- media gallery start --}}
                      ...
                      <div class="image view view-first">
                        <img style="height:50%;" width="50%" src='/{{ $gallery->image }}' alt="{{ $gallery->image }}" />
                        <div class="mask">
                          <p> <a href="{{ url($gallery->image) }}" target="_blank"> <b style="font-size: 24px; color:aliceblue">Open Image</b> </a> </p>
                          <div class="tools tools-bottom">
                            <a href="{{ url($gallery->image) }}" target="_blank"><i class="fa fa-eye"></i></a>
                          </div>
                        </div>
                      </div>
                  ...
                  <div class="x_panel">
                    ...
                    <div class="x_content">
                     ...
                     <div class="caption">
                        ...
                        <p>Created:  {{ $gallery->created_at }}</p><hr>
                      </div>
                     ...
                     <div class="modal-dialog modal-lg" role="document">
                         <div class="modal-content">
                             ...
                             <div class="modal-body">
                                ...
                                <form action="/gallerys/{{ $gallery->id }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                    <div class="row">
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        @enderror
                                        <input type="text" value="{{ $gallery->location }}" name="location" class="form-control" id="cat" >
                                    </div>
