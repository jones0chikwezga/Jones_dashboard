                ...
                <div class="col-md-12 col-sm-12 ">
                  <div class="x_panel">
                    ...
                    <div class="x_content">
                     ...
                     <div class="caption">
                      <p>From: <i class="fa fa-tag"></i>  {{ $message->email }} </p> <hr>
                      <p>Created:  {{ $message->created_at }} </p><hr>
                      <p>Content:  {{ $message->message }} </p><hr>
                      <br>
                      <a href="mailto:{{ $message->email }}" class="btn btn-primary">send email</a>
