...
<div class="clearfix"></div>
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Vacancy Preview : {{ $vacancy->position }} <small></small></h2>
                  ...
                  <div class="col-md-100">
                    <div class="thumbnail">
                      <div class="image view view-first">
                        <img style="height:500%;" src='{{ asset('dash/images/pdf.png') }}' alt="{{ $vacancy->file }}" />
                        <div class="mask">
                          <p> <a href="{{ url($vacancy->file) }}" target="_blank"> <b style="font-size: 24px; color:aliceblue">Open Document</b> </a> </p>
                          <div class="tools tools-bottom">
                            <a href="{{ url($vacancy->file) }}" target="_blank"><i class="fa fa-eye"></i></a>
                          </div>
                        </div>
                      </div>
                      <div class="caption">
                        <p>POSITION: {{ $vacancy->position }}</p>
                        <p>POSTED: {{ $vacancy->created_at }}</p><hr>
                      </div>
                    </div>
                  </div>
                ...
                <div class="col-md-12 col-sm-12 ">
                  <div class="x_panel">
                    ...
                    <div class="x_content">
                     ...
                     <div class="caption">
                      <p>DUTIES: {!! $vacancy->duties !!}</p> <hr>
                      <p>QUALIFICATION: {!! $vacancy->qualification !!}</p><hr>
                      <p>CLOSING DATA: {{ $vacancy->closing_date }}</p><hr>
                    </div>
                                 ...
                                 @method('PUT')
                                     <div class="row">
                                       ...
                                       <div class="form-group col-md-12">
                                         ...
                                         @enderror
                                         <input type="text" value="{{ $vacancy->position }}" name="position" class="form-control" id="cat" >
                                     </div>
                                     ...
                                     <div class="form-group col-md-12">
                                         ...
                                         @enderror
                                         <textarea name="duties" value="{{ $vacancy->duties }}" class="form-control" id="cat">{{ $vacancy->duties }}</textarea>
                                     </div>
                                     ...
                                     <div class="form-group col-md-12">
                                         ...
                                         @enderror
                                         <textarea name="qualification" value="{{ $vacancy->qualification }}" class="form-control" id="cat">{{ $vacancy->qualification }}</textarea>
                                     </div>
                                     ...
                                     <div class="form-group col-md-12">
                                         ...
                                         @enderror
                                         <input type="date" value="{{ $vacancy->closing_date }}" name="closing_date" class="form-control" id="cat" >
                                     </div>
                                   ...
                                   <div class="form-group col-md-12">
                                     ...
                                     @enderror
                                     <input type="file" value="{{ $vacancy->file }}" name="file" class="form-control" id="cat">
                                 </div>
