                      ...
                      <tbody>
                        ...
                        <tr>
                         ...
                         <td>{{ $item->category }}</td>
                          ...
                          <td><a class = "btn btn-primary btn-sm" href="/blogs/{{ $item->id }}"> <i class="fa fa-pencil"></i> </a> </td>
                        </tr>
                        @endforeach
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="varyModalLabel">Add News</h5>
                                ...
                                <div class="modal-body">
                                  @include('alerts.success')
                                    <form action="/newz" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    @method('POST')
                                        <div class="row">
                                          ...
                                          <div class="form-group col-md-12">
                                            ...
                                            @enderror
                                            <input type="text" name="news_title" class="form-control" id="cat" >
                                        </div>
