            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a href="<?php echo e(url('/story')); ?>"><i class="fa fa-users"></i> Successful Stories <span class=""></span></a>

                  </li>

                  <li><a href="<?php echo e(url('/video')); ?>"><i class="fa fa-cog"></i> Videos <span class=""></span></a>
                  ...
                  <li><a href="<?php echo e(url('/program')); ?>"><i class="fa fa-cog"></i> Programs <span class=""></span></a>
...
<?php /**PATH E:\yodep\resources\views/layouts/app.blade.php ENDPATH**/ ?>