                                ...
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                    <div class="post-holder">
                                        <div class="post-block mb40">
                                            <div class="col-xl-6">
                                                <a href="/blog/<?php echo e($item->id); ?>" class="imghover"><img src="<?php echo e($item->image); ?>" width="50%" alt="blog.blogTitle" class="img-fluid"></a>
                                            </div>
                                            <div class="bg-white">
                                                <h2><a href="/blog/<?php echo e($item->id); ?>" class="title"><?php echo e($item->blog_title); ?></a></h2>
                                                        ...
                                                        <div class="recent-block mb20">
                                                            <div class="row">
                                                                <div class="col-xl-4 col-lg-4 col-md-2 col-sm-5 col-5">
                                                                    <a href="/blog/<?php echo e($item->id); ?>"><img src="<?php echo e($item->image); ?>" alt="blog.blogTitle" class="img-fluid mb10"></a>
                                                                </div>
                                                                <div class="col-xl-8 col-lg-8 col-md-10 col-sm-7 col-7">
                                                                    <h4 class="recent-title mb10"><a href="/blog/<?php echo e($item->id); ?>" class="title"><?php echo e($item->blog_title); ?></a></h4>
                                                                    <div class="meta">
                                                                        <!-- post meta -->
...
<?php /**PATH /home/u289533873/domains/dreamcodemw.com/public_html/yodep/resources/views/website/blog/index.blade.php ENDPATH**/ ?>