...
<html  lang="en">
    <head>
        <title>YODEP &mdash; successful stories</title>
        <meta charset="utf-8">
                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="page-breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="active">OUR SUCCESSFUL STORIES</li>
                        </ol>
                    </div>
                </div>
                 <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="bg-white pinside30">
                        <div class="row">
                           <div class="col-xl-4 col-lg-4 col-md-9 col-sm-12 col-12">
                                <h1 class="page-title">OUR SUCCESSFUL STORIES</h1>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-xl-8 col-lg-8 col-md-12 col-sm-12 col-12">
                            <div class="row">
                                ...
                                <?php $__currentLoopData = $allstories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                    <div class="post-holder">
                                        <div class="post-block mb40">
                                            ...
                                            <div class="card">
                                                <iframe height="385" src="<?php echo e($item->link); ?>">
                                                </iframe>
                                            ...
                                            <?php else: ?>
                                            <div class="col-xl-6">
                                                <a href="/stories/<?php echo e($item->id); ?>" class="imghover"><img src="<?php echo e($item->image); ?>" alt="" class="img-fluid"></a>
                                            </div>
                                            <?php endif; ?>

                                            <div class="bg-white">
                                                <h2><a href="/stories/<?php echo e($item->id); ?>" class="title"><?php echo e($item->title); ?></a></h2>
                                                ...
                                                <p><?php echo e(strip_tags(Str::limit($item->body, 50))); ?> <a href="/stories/<?php echo e($item->id); ?>"> ReadMore >> </a></p> </div>
                                        </div>
                                    </div>
                                </div>
                                <!-- {% endfor %} -->
                                                    ...
                                                    <li>
                                                        <div class="recent-block mb20">
                                                            <div class="row">
                                                                ...
                                                                <div class="card">
                                                                    <iframe width="60" height="60" src="<?php echo e($item->link); ?>">
                                                                    </iframe>
                                                                ...
                                                                <?php else: ?>
                                                                <div class="col-xl-4 col-lg-4 col-md-2 col-sm-5 col-5">
                                                                    <a href="/stories/<?php echo e($item->id); ?>"><img src="<?php echo e($item->image); ?>" alt="blog.blogTitle" class="img-fluid mb10"></a>
                                                                </div>
                                                                <?php endif; ?>

                                                                <div class="col-xl-8 col-lg-8 col-md-10 col-sm-7 col-7">
                                                                    <h4 class="recent-title mb10"><a href="/stories/<?php echo e($item->id); ?>" class="title"><?php echo e($item->title); ?></a></h4>
                                                                    <div class="meta">
                                                                        <!-- post meta -->
                                                                        <span class="meta-date"><?php echo e($item->created_at); ?> </span> </div>
                                                                    <!-- /.post meta -->
                                                                </div>
                                                            </div>
                                                        </div>
...
<?php /**PATH /home/u289533873/domains/dreamcodemw.com/public_html/yodep/resources/views/website/story/index.blade.php ENDPATH**/ ?>