...
<div class="clearfix"></div>
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Manage Blogs <small></small></h2>
                      ...
                      <tbody>
                        ...
                        <tr>
                         ...
                         <td><?php echo e($item->category); ?></td>
                          ...
                          <td><a class = "btn btn-primary btn-sm" href="/blogs/<?php echo e($item->id); ?>"> <i class="fa fa-pencil"></i> </a> </td>
                        </tr>
                        ...
                        <div class="modal-dialog modal-lg" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="varyModalLabel">New Blog</h5>
...
unset($__errorArgs, $__bag); ?>
                                            <input type="text" name="blog_title" value="<?php echo e(old('blog_title')); ?>" class="form-control" id="cat" >
                                        </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u289533873/domains/dreamcodemw.com/public_html/nyale/resources/views/admin/blog/index.blade.php ENDPATH**/ ?>