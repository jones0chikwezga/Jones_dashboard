...
<html lang="en">
  ...
  <head>
    ...
    <title>Nyale Institute | ADMIN</title>
    ...
    <link href="<?php echo e(asset('dash/vendors/bootstrap-progressbar/css/bootstrap-progressbar-3.3.4.min.css')); ?>" rel="stylesheet">
...
<link href="<?php echo e(asset('dash/vendors/google-code-prettify/bin/prettify.min.css')); ?>" rel="stylesheet">
      ...
      <link href="<?php echo e(asset('/dash/vendors/datatables.net-fixedheader-bs/css/fixedHeader.bootstrap.min.css')); ?>" rel="stylesheet">
      <link href="<?php echo e(asset('/dash/vendors/datatables.net-responsive-bs/css/responsive.bootstrap.min.css')); ?>" rel="stylesheet">
      <link href="<?php echo e(asset('/dash/vendors/datatables.net-scroller-bs/css/scroller.bootstrap.min.css')); ?>" rel="stylesheet">
      ...
      <div class="main_container">
          ...
          <div class="left_col scroll-view">
            ...
            <div class="profile clearfix">
              <div class="profile_pic">
                <img src="<?php echo e(asset('dash/images/img.png')); ?>" alt="..." class="img-circle profile_img">
              </div>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  <li><a href="<?php echo e(url('/home')); ?>"><i class="fa fa-home"></i> Home <span class=""></span></a>

                  </li>

                  <li><a href="<?php echo e(url('/user')); ?>"><i class="fa fa-users"></i> Users <span class=""></span></a>

                  </li>

                  <li><a href="<?php echo e(url('/blogs')); ?>"><i class="fa fa-clipboard"></i> Blogs <span class=""></span></a>

                  </li>

                  

                  <li><a href="<?php echo e(url('/application')); ?>"><i class="fa fa-download"></i>Job Applications <span class=""></span></a>

                  </li>


                  <li><a href="<?php echo e(url('/volunteer')); ?>"><i class="fa fa-download"></i>Volunteering <span class=""></span></a>

                  </li>

                  <li><a href="<?php echo e(url('/messages')); ?>"><i class="fa fa-envelope"></i>Direct Messages <span class=""></span></a>

                  </li>

                  <li><a href="<?php echo e(url('/contactus')); ?>"><i class="fa fa-envelope"></i>Contact-us Messages <span class=""></span></a>

                  </li>

                  <li><a href="<?php echo e(url('/event')); ?>"><i class="fa fa-calendar"></i> Events <span class=""></span></a>

                  </li>

                  <li><a href="<?php echo e(url('/vacancy')); ?>"><i class="fa fa-bullhorn"></i> Vacancies <span class=""></span></a>

                  </li>

                  <li><a href="<?php echo e(url('/files')); ?>"><i class="fa fa-file"></i> Resources <span class=""></span></a>

                  </li>

                  <li><a href="<?php echo e(url('/gallerys')); ?>"><i class="fa fa-file"></i> Gallery <span class=""></span></a>

                  </li>

                  <li><a href="<?php echo e(url('/causes')); ?>"><i class="fa fa-bullhorn"></i> Causes <span class=""></span></a>

                  </li>

                  <li><a href="<?php echo e(url('/partners')); ?>"><i class="fa fa-users"></i> Partners <span class=""></span></a>

                  </li>

                  <li><a href="<?php echo e(url('/teams')); ?>"><i class="fa fa-users"></i> Team <span class=""></span></a>

                  </li>

                  <li><a href="<?php echo e(url('/testimonials')); ?>"><i class="fa fa-users"></i> Testimonial <span class=""></span></a>

                  </li>

                  <li><a href="<?php echo e(url('/case_tracker_page')); ?>"><i class="fa fa-users"></i> Cases <span class=""></span></a>

                  </li>

                  

                  <li><a href="<?php echo e(url('/category')); ?>"><i class="fa fa-list"></i> Categories <span class=""></span></a>

                  </li>

                  <li><a href="<?php echo e(url('/stats')); ?>"><i class="fa fa-list"></i> Stats <span class=""></span></a>

                  </li>

                   <li><a href="<?php echo e(url('/slide')); ?>"><i class="fa fa-cog"></i> Slideshows <span class=""></span></a>

                  </li> 

                  <li><a href="<?php echo e(url('/program')); ?>"><i class="fa fa-cog"></i> What we do <span class=""></span></a>
                ...
                <ul class=" navbar-right">
                  <li class="nav-item dropdown open" style="padding-left: 15px;">
                    <a href="javascript:;" class="user-profile dropdown-toggle" aria-haspopup="true" id="navbarDropdown" data-toggle="dropdown" aria-expanded="false">
                      <img src="<?php echo e(asset('dash/images/img.png')); ?>" alt=""><?php echo e(auth()->user()->name); ?>
                    ...
                    <ul class="dropdown-menu list-unstyled msg_list" role="menu" aria-labelledby="navbarDropdown1">
                      <li class="nav-item">
                        <a class="dropdown-item" href = "<?php echo e(url('/messages')); ?>">
                          <span class="image"><img src="<?php echo e(asset('dash/images/img.png')); ?>" alt="Profile Image" /></span>
                          <span>
                            <span>admin</span>
        ...
        <footer>
          <div class="pull-right">
            Admin <a href="#">Nyale Institute</a>
          </div>
          <div class="clearfix"></div>
        </footer>
        <!-- /footer content -->
...
<?php /**PATH /home/u289533873/domains/dreamcodemw.com/public_html/nyale/resources/views/layouts/app.blade.php ENDPATH**/ ?>