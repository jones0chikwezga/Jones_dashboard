...
<div class="clearfix"></div>
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Manage Successful Stories <small></small></h2>
                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered" style="width:100%">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td><a class = "btn btn-primary btn-sm" href="/story/<?php echo e($item->id); ?>"> <i class="fa fa-pencil"></i> </a> </td>
                        </tr>
...
unset($__errorArgs, $__bag); ?>
                                            <input type="text" value="<?php echo e(old('link')); ?>" name="link" class="form-control" id="cat" >
                                        </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u289533873/domains/dreamcodemw.com/public_html/yodep/resources/views/admin/stories/index.blade.php ENDPATH**/ ?>