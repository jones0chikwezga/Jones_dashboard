                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                      <?php $__currentLoopData = $events; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="card-deck">
                            ...
                            <div class="card">
                                <div class="post-img">
                                    <a href="/events/<?php echo e($item->id); ?>" class="imghover"><img src="<?php echo e($item->image); ?>" alt="Borrow - Loan Company Website Template" class="img-fluid"></a>
                                </div>
                              <div class="card-body">
                                <h3><a href="/events/<?php echo e($item->id); ?>" class="title"><?php echo e($item->event_title); ?></a></h3>
...
<?php /**PATH E:\adra_larav\resources\views/website/events/index.blade.php ENDPATH**/ ?>