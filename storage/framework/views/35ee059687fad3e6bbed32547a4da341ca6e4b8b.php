                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="page-breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="active">OUR VACANCIES</li>
                        </ol>
                    </div>
                </div>
                 <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="bg-white pinside30">
                        <div class="row">
                           <div class="col-xl-4 col-lg-4 col-md-9 col-sm-12 col-12">
                                <h1 class="page-title">OUR VACANCIES</h1>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
                            <div class="bg-white pinside40 number-block mb30 outline">
                                ...
                                <p> <?php echo e(strip_tags(Str::limit($item->duties, 60))); ?></p>
                                <small class="my-0">Apply before <?php echo e($item->closing_date); ?></small>
                                <a href="vacancies/<?php echo e($item->id); ?>" class="btn btn-outline">Apply</a>
                            </div>
                        </div>
...
<?php /**PATH /home/u289533873/domains/dreamcodemw.com/public_html/yodep/resources/views/website/vacancy/index.blade.php ENDPATH**/ ?>