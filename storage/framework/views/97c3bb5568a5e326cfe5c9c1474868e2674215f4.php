...
<html lang="en">
   <head>
     ...
     <!-- fevicon -->
     <link rel="icon" href="<?php echo e(asset('web/images/fevicon.png')); ?>" type="image/gif" />
     <!-- Scrollbar Custom CSS -->
     <link rel="stylesheet"  type="text/css" href="<?php echo e(asset('web/css/jquery.mCustomScrollbar.min.css')); ?>">
     ...
     <link rel="stylesheet"  type="text/css" href="<?php echo e(asset('web/css/owl.theme.default.min.css')); ?>">
   ...
   <body>
      ...
      <div class="header_section">
         <nav class="navbar navbar-expand-lg navbar-light bg-light">
            <a class="navbar-brand"><a href="<?php echo e(url('/')); ?>"><img src="<?php echo e(asset('web/images/logo.png')); ?>"></a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
               <ul class="navbar-nav mr-auto">
                <li class="nav-item">
                 ...
                 <li class="nav-item">
                    <a class="nav-link" href="<?php echo e(url('/donate')); ?>">Donate</a>
                 </li>
                 <li class="nav-item">
                 ...
                 <li class="nav-item active">
                    <a class="nav-link" href="<?php echo e(url('/mission')); ?>">Our Mission</a>
                 </li>
               </ul>
               <form class="form-inline my-2 my-lg-0">
                  <div class="search_icon"><a href="#"><img src="<?php echo e(asset('web/images/search-icon.png')); ?>"></a></div>
      ...
      <div class="mission_section layout_padding">
            ...
            <div class="row">
               ...
               <div class="col-md-5">
                  <div class="container_main">
                     <img src="<?php echo e(asset('web/images/img-1.png')); ?>" alt="Avatar" class="image">
                     <div class="overlay">
                        <div class="text">
               ...
               <div class="col-md-5">
                  <div class="container_main">
                     <img src="<?php echo e(asset('web/images/img-2.png')); ?>" alt="Avatar" class="image">
                     <div class="overlay">
                        <div class="text">
                           <h4 class="some_text">whichalteration in some </h4>
                           <p class="alteration_text">Alteration in some form, by injected humour, or randomised words whichalteration in some form, by injected humour, or randomised words which</p>
         ...
         <div class="mission_section_2">
            <div class="row">
               <div class="col-md-5">
                  <div class="container_main">
                     <img src="<?php echo e(asset('web/images/img-3.png')); ?>" alt="Avatar" class="image">
                     <div class="overlay">
                        <div class="text">
                           <h4 class="some_text">whichalteration in some </h4>
                           <p class="alteration_text">Alteration in some form, by injected humour, or randomised words whichalteration in some form, by injected humour, or randomised words which</p>
               ...
               <div class="col-md-5">
                  <div class="container_main">
                     <img src="<?php echo e(asset('web/images/img-4.png')); ?>" alt="Avatar" class="image">
                     <div class="overlay">
                        <div class="text">
                           <h4 class="some_text">whichalteration in some </h4>
                           <p class="alteration_text">Alteration in some form, by injected humour, or randomised words whichalteration in some form, by injected humour, or randomised words which</p>
         ...
         <div class="mission_section_2">
            <div class="row">
               ...
               <div class="col-md-5">
                  <div class="container_main">
                     <img src="<?php echo e(asset('web/images/img-5.png')); ?>" alt="Avatar" class="image">
                     <div class="overlay">
                        <div class="text">
                           <h4 class="some_text">whichalteration in some </h4>
                           <p class="alteration_text">Alteration in some form, by injected humour, or randomised words whichalteration in some form, by injected humour, or randomised words which</p>
               ...
               <div class="col-md-5">
                  <div class="container_main">
                     <img src="<?php echo e(asset('web/images/img-6.png')); ?>" alt="Avatar" class="image">
                     <div class="overlay">
                        <div class="text">
                           <h4 class="some_text">whichalteration in some </h4>
                           <p class="alteration_text">Alteration in some form, by injected humour, or randomised words whichalteration in some form, by injected humour, or randomised words which</p>
         ...
         <div class="container">
            <div class="row">
               <div class="col-sm-6 col-md-6 col-lg-3">
                  <div class="footer_logo"><img src="<?php echo e(asset('web/images/footer-logo.png')); ?>"></div>
               </div>
               <div class="col-sm-6 col-md-6 col-lg-3">
               ...
               <div class="row">
                  <div class="col-sm-4 col-md-4 col-lg-3">
                     <div class="social_icon">
                        <ul>
                           <li><a href="#"><img src="<?php echo e(asset('web/images/fb-icon.png')); ?>"></a></li>
                           <li><a href="#"><img src="<?php echo e(asset('web/images/twitter-icon.png')); ?>"></a></li>
                           <!--<li><a href="#"><img src="<?php echo e(asset('web/images/linkedin-icon.png')); ?>"></a></li>-->
                           <li><a href="#"><img src="<?php echo e(asset('web/images/instagram-icon.png')); ?>"></a></li>
                        </ul>
                     </div>
                  </div>
      ...
      <script src="<?php echo e(asset('web/js/jquery-3.0.0.min.js')); ?>"></script>
      <script src="<?php echo e(asset('web/js/plugin.js')); ?>"></script>
      <!-- sidebar -->
...
<?php /**PATH C:\Users\DreamCode\Documents\projects\laravel\nyale_institute\resources\views/website/mission/index.blade.php ENDPATH**/ ?>