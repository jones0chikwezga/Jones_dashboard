                                ...
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                    <div class="post-holder">
                                        <div class="post-block mb40">
                                            <div class="post-img mb30"><img src="/<?php echo e($event->image); ?>" alt="Borrow - Loan Company Website Template" class="img-fluid"></div>
                                            <div class="bg-white">
                                                <h1><?php echo e($event->event_title); ?> </h1>
                                                <p class="meta"><span class="meta-date"><?php echo e($event->date); ?></span></p>
...
<?php /**PATH /home/u289533873/domains/dreamcodemw.com/public_html/yodep/resources/views/website/events/show.blade.php ENDPATH**/ ?>