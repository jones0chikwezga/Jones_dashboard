...
<div class="clearfix"></div>
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>successful story Preview <small></small></h2>
                    <ul class="nav navbar-right panel_toolbox">
                      <form action="/story/<?php echo e($story->id); ?>" method="post">
                        <?php echo csrf_field(); ?>
                     ...
                     <div class="modal-dialog modal-lg" role="document">
                         <div class="modal-content">
                             <div class="modal-header">
                                 <h5 class="modal-title" id="varyModalLabel">Edit story</h5>
                             ...
                             <div class="modal-body">
                                ...
                                <form action="/story/<?php echo e($story->id); ?>" method="POST" enctype="multipart/form-data">
                                    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                                            <input type="text" name="link" value ="<?php echo e($story->link); ?>" class="form-control" id="cat" >
                                        </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u289533873/domains/dreamcodemw.com/public_html/yodep/resources/views/admin/stories/show.blade.php ENDPATH**/ ?>