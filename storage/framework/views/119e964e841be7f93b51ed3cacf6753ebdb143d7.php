                  ...
                  <div class="col-md-100">
                    <div class="thumbnail">
                      <div class="image view view-first">
                        <img style="height:500%;" src='<?php echo e(asset($file_details->file)); ?>' alt="<?php echo e($file_details->file); ?>" />
                        <div class="mask">
                          <p> <a href="<?php echo e(url($file_details->file)); ?>" target="_blank">Open</a> </p>
                          <div class="tools tools-bottom">
                            <a href="<?php echo e(url($file_details->file)); ?>" target="_blank"><i class="fa fa-eye"></i></a>
                          </div>
                        </div>
                      </div>
                      <div class="caption">
                        <p><?php echo e($file_details->description); ?></p>
                      </div>
                    </div>
                  </div>
...
unset($__errorArgs, $__bag); ?>
                          ...
                          <input type="text" value="<?php echo e($file_details->description); ?>" name="description" class="form-control">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Projects\Yodep-Laravel\resources\views/admin/files/show.blade.php ENDPATH**/ ?>