...
<script>
  ...
  gtag('config', 'G-BP872SWEL0');
        ...
        <title>YODEP &mdash; Events</title>
        <meta charset="utf-8">
    ...
    <div class="row">
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
            <div class="wrapper-content bg-white pinside40">
                <div class="row">
                    <?php $__currentLoopData = $events->chunk(3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="row">
                      ...
                      <div class="col-xl-4">
                        <div class="card">
                          <div class="post-img">
                            <a href="/events/<?php echo e($item->id); ?>" class="imghover">
                              <img src="<?php echo e($item->image); ?>" alt="Borrow - Loan Company Website Template" class="img-fluid">
                            </a>
                          </div>
                          <div class="card-body">
                            <h3>
                              <a href="/events/<?php echo e($item->id); ?>" class="title"><?php echo e($item->event_title); ?></a>
                            </h3>
                            <p><?php echo e(strip_tags(Str::limit($item->content, 50))); ?> <a href="/events/<?php echo e($item->id); ?>"> ReadMore >> </a></p>
                          </div>
                          <div class="card-footer">
                            <small class="text-muted"><?php echo e($item->date); ?> from <?php echo e($item->starttime); ?> - <?php echo e($item->endtime); ?></small>
                          </div>
                        </div>
                      </div>
...
<?php /**PATH /home/u289533873/domains/dreamcodemw.com/public_html/yodep/resources/views/website/events/index.blade.php ENDPATH**/ ?>