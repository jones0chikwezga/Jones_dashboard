            ...
            <div class="row">
                <div class="col-xl-2 col-lg-2 col-md-12 col-sm-6 col-6">
                    ...
                    <div class="logo">
                        ...
                        <a href=""><img src="<?php echo e(asset('images/logo2.png')); ?>" style="width: 90px;"
    ...
    <div class="slider" id="slider">
        ...
        <?php $__currentLoopData = $slidepics; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="slider-img"
                style="background: linear-gradient(rgba(16, 76, 149, 0.281), rgba(16, 76, 149, 0.301)), rgba(16, 76, 149, 0.281)">
        ...
        <div class="container text-center">
            ...
            <div class="card-deck">
                <?php $__currentLoopData = $events; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="card">
                        <div class="post-img">
                            <a href="/events/<?php echo e($item->id); ?>" class="imghover"><img src="<?php echo e($item->image); ?>"
...
<?php /**PATH E:\yodep\resources\views/website/index.blade.php ENDPATH**/ ?>