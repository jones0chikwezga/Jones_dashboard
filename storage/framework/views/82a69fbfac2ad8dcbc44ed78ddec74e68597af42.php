...
unset($__errorArgs, $__bag); ?>
                            <input type="text" value = "<?php echo e($item->heading); ?>" name="heading" class="form-control" id="cat">
                        </div>
...
unset($__errorArgs, $__bag); ?>
                            <textarea name="body" value = "<?php echo e($item->body); ?>" class="form-control" id="cat"><?php echo e($item->body); ?></textarea>
                        </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u289533873/domains/dreamcodemw.com/public_html/nyale/resources/views/admin/slideshows/index.blade.php ENDPATH**/ ?>