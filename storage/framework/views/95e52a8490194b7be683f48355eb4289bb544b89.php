            ...
            <div class="row">
                <div class="offset-xl-2 col-xl-8 offset-lg-2 col-lg-8 offset-md-2 col-md-8 col-sm-12 col-12">
                    <div class="mb60 text-center section-title">
                        ...
                        <p>Stories from the community</p>
                    </div>
                    <!-- /.section title start-->
                </div>
            </div>
            <div class="row">
                ...
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
                    <div class="testimonial-block mb30">
                        <!--<div style="height: 150px; overflow-y: scroll;" class="bg-white outline pinside30 mb20">-->
                        <!--    <p class="testimonial-text"><?php echo e(strip_tags($item->body)); ?>  </p>-->
                        <!--</div>-->
                        <!--<div class="testimonial-autor-box mb30">-->
                        <!--    <div class="testimonial-img"> <img style="height: 50px;" src="<?php echo e($item->image); ?>" alt="Borrow - Loan Company Website Template"> </div>-->
                        <!--    <div class="testimonial-autor">-->
                        <!--        <h4 class="text-primary"><?php echo e($item->name); ?></h4>-->
                        <!--        <span class="testimonial-meta"><?php echo e($item->title); ?></span>-->
                        <!--    </div>-->
                        <!--</div>-->
                        <div class="container">
                            <div class="active">
                                <div class="img"><img src="<?php echo e($item->image); ?>" alt="" class="" style="height: 80px;"></div>
...
<?php /**PATH /home/u289533873/domains/dreamcodemw.com/public_html/yodep/resources/views/website/testimonial/index.blade.php ENDPATH**/ ?>