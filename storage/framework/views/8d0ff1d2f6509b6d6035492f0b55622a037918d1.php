            ...
            <div class="col-lg-8">
                ...
                <div class="single-comment">
                    ...
                    <ul class="comment-list">
                      ...
                      <?php if($currentfollowup): ?>
                        <li class="comment-item">
                            <div class="comment-body">
                                
                                <div class="comment-text">
                                    <h3><a href=""><?php echo e($currentfollowup->created_at->format('M Y')); ?></a></h3>
                                    <span>By Admin</span>
                                    
                                    <p>
                                        <?php echo $currentfollowup->comment; ?> 
                                    </p>
                    ...
                    <ul class="comment-list">
                        ...
                        <li class="comment-item">
                            <div class="comment-body">
                                ...
                                <div class="comment-text">
                                    <h3><a href=""><?php echo e($item->created_at->format('M Y')); ?></a></h3>
                                    <span>By Admin</span>
                                    <p>
                            ...
                            <div class="">
                               <?php $__currentLoopData = $cases; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <div class="post-item">
                                    ...
                                    <div class="post-text">
                                        <a href="/our_work/<?php echo e($item->id); ?>"><?php echo e($item->title); ?></a>
                                        <div class="post-meta">
