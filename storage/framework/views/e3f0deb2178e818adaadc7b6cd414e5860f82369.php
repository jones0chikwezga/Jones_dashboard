                ...
                <div class="x_panel">
                  <div class="x_title">
                    ...
                    <ul class="nav navbar-right panel_toolbox">
                      <form action="/video/<?php echo e($video->id); ?>" method="post">
                        <?php echo csrf_field(); ?>
                  ...
                  <div class="col-md-100">
                      ...
                      <div class="image view view-first">
                        <iframe width="600" height="315" src="<?php echo e($video->url_link); ?>">
                        </iframe>
                  ...
                  <div class="x_panel">
                    ...
                    <div class="x_content">
                     ...
                     <div class="caption">
                        ...
                        <p>Title:  <?php echo e($video->title); ?> </p><hr>
                        <p>Video Link:  <?php echo e($video->url_link); ?></p><hr>
                        <p>Created:  <?php echo e($video->created_at); ?></p><hr>
                      </div>
                     ...
                     <div class="modal-dialog modal-lg" role="document">
                         <div class="modal-content">
                             ...
                             <div class="modal-body">
                                ...
                                <form action="/video/<?php echo e($video->id); ?>" method="POST" enctype="multipart/form-data">
                                    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                                            <input type="text" name="title" value ="<?php echo e($video->title); ?>" class="form-control" id="cat" >
                                        </div>

                                        <div class="form-group col-md-12">
                                            <label for="recipient-name" class="col-form-label"> Video Link</label>
                                            <?php $__errorArgs = ['url_link'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                            <input type="text" name="url_link" value ="<?php echo e($video->url_link); ?>" class="form-control" id="cat" >
                                        </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\yodep\resources\views/admin/videos/show.blade.php ENDPATH**/ ?>