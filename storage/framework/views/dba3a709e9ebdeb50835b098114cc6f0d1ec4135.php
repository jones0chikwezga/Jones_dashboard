                  ...
                  <div class="x_panel">
                    ...
                    <div class="x_content">
                     ...
                     <div class="caption">
                      ...
                      <p>Comment Details  <?php echo $item->comment; ?>    <form action="/followup/<?php echo e($item->id); ?>" method="post">
                        <?php echo csrf_field(); ?>
                        <?php echo method_field('delete'); ?>
