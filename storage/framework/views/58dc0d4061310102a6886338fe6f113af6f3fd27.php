...
<html  lang="en">
    <head>
        <title>YODEP &mdash; Partener</title>
        <meta charset="utf-8">
                        ...
                        <ul class="bg-primary rounded">
                            ...
                            <li><a href="" class="animsition-link">More</a>
                                <ul>
                                    ...
                                    <li><a href="<?php echo e(url('/contact')); ?>" title="contact us" class="animsition-link">Contatct Us</a></li>
                ...
                <div class="wrapper-content bg-white pinside40">
                    <div class="offset-xl-2 col-xl-8 offset-lg-2 col-lg-8 col-md-12 col-sm-12 col-12">
                        <div class="mb60  section-title text-center  ">
                            <!-- section title start-->
                            <p>We are very proud of our partners and we really appreciate the efforts you devote to the operation of this organization.
                                We have taken a minute to appreciate and give a special recognition to our partners here.</p>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12">
                            <div class="post-block mb30">
                                <div class="bg-white pinside40 outline">
                                        ...
                                        <a href=""><img width="50%" src="<?php echo e($item->image); ?>" alt="partner" class="img mb20"></a>
                                    
                                    <h3 class="title"><?php echo e($item->name); ?></h3>
                                    <p class="meta"><span class="meta-date"> <i class="icon-placeholder-3 icon-1x"></i> <?php echo e($item->location); ?></span></p>
                                </div>
                            </div>
                        </div>
                        <!-- {% endfor %} -->
...
<?php /**PATH E:\adra_larav\resources\views/website/partner/index.blade.php ENDPATH**/ ?>