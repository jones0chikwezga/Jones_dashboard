...
<script>
  ...
  gtag('config', 'G-BP872SWEL0');
        ...
        <title>YODEP &mdash; What We Do</title>
        <meta charset="utf-8">
...
<div class="mb-4 container">
    ...
    <div class="row mt-4">
        <div class="col-sm-3"><img src="<?php echo e($item->image); ?>" alt="" style="" class="img-fluid"></div>
        <div class="col-sm-8">
            <div class="card">
                <div class="card-body">
...
<?php /**PATH /home/u289533873/domains/dreamcodemw.com/public_html/nyale/resources/views/website/what/index.blade.php ENDPATH**/ ?>