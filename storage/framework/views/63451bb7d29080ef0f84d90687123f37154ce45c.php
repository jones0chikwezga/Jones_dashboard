                    ...
                    <div class="about-section pinside40">
                        <div class="row">
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                <h2 class="mb30">The Mission</h2>
                                <p >YODEP exist to create an environment where children and young people in Malawi live to 
                                    their full potential through Early childhood Development, Basic Education, improved livelihood, Sexual and Reproductive 
                                    Health initiatives, skills building, health, human rights, and humanitarian support.</p>
                            </div>
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                <div class="mb60">
                                    <h2 class="mb30">The Vision</h2>
                                    
                                    <p>A Malawian society where citizens are healthy, literate, self-reliant, and free from abject poverty and hopelessness.</p>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="section-title text-center mb60">
                                    <h2>Our Management Team at YODEP</h2>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
                                <div class="team-block mb30">
                                    <div class="team-img mb30"> <img src="<?php echo e($item->image); ?>" alt="Borrow - Loan Company Website Template" class="img-fluid"> </div>
                                    <div class="team-content text-center">
                                        <h3><?php echo e($item->name); ?></h3>
                                        <small class="designation text-primary"><?php echo e($item->position); ?></small>
                                    </div>
                                </div>
                            </div>
                            <!-- {% endfor %} -->
...
</html><?php /**PATH E:\adra_larav\resources\views/website/about/index.blade.php ENDPATH**/ ?>