                                ...
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                    <div class="post-holder">
                                        <div class="col-xl-6 mb40">
                                            <div class="post-img mb30"><img src="/<?php echo e($blog->image); ?>" alt="blog.blogTitle" class="img-fluid"></div>
                                            <div class="bg-white">
                                                <h1><?php echo e($blog->blog_title); ?></h1>
                                                <p class="meta"><span class="meta-date"><?php echo e($blog->created_at); ?></span><span class="meta-author">By<a href="#" class="meta-link"> Admin</a></span></p>
                                                        ...
                                                        <div class="post-holder">
                                                            <div class="post-block mb40">
                                                                <div class="col-xl-8 mb30">
                                                                    <a href="/blog/<?php echo e($item->id); ?>" class="imghover"><img src="/<?php echo e($item->image); ?>" alt="blog.blogTitle" class="img-fluid"></a>
                                                                </div>
                                                                <div class="bg-white">
                                                                    <h4><a href="/blog/<?php echo e($item->id); ?>" class="title"><?php echo e($item->blog_title); ?></a></h4>
                                                                    ...
                                                                    <p><?php echo e(strip_tags(Str::limit($item->content, 30))); ?> </p>
                                                                    <a href="/blog/<?php echo e($item->id); ?>" class="btn-link">Read More</a> </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <!-- {% endfor %} -->
...
<?php /**PATH /home/u289533873/domains/dreamcodemw.com/public_html/yodep/resources/views/website/blog/show.blade.php ENDPATH**/ ?>